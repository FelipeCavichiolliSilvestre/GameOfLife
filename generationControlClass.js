class GenerationControl {
  ...
  constructor(boardObject) {
    ...
    PAUSE_BTN.addEventListener(
      "click",
      this.userClickedPause.bind(this),
      false
    );
    STEP_BTN.addEventListener("click", this.userClickedStep.bind(this), false);
    RESET_BTN.addEventListener(
      "click",
      this.userClickedReset.bind(this),
      false
    );
    GEN_HIDE_BTN.addEventListener(
      "click",
      this.userClickedHide.bind(this),
      false
    );
    SPEED_SLIDE.addEventListener(
      "input",
      this.userChangedSimulationSpeed.bind(this),
      false
    );
  }
  ...
  userClickedPlay() {
    ...
    this.interval = window.setInterval(
      this.userClickedStep.bind(this),
